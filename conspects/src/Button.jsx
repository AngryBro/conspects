const Button = ({text, className, style = {display: 'flex'}, onClick, loading}) => {

    return <div style={style} className={className} onClick={onClick}>
        <div>{text}</div>
        <div className="loader">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 512" fill="red">
